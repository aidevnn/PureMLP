...
namespace PureMLP
{
    public static class ImportData
    {
        ...
        public static (NDarray, NDarray, NDarray, NDarray) DigitsDataset(double ratio)
        {
        ...
        public static (NDarray, NDarray, NDarray, NDarray) IrisDataset(double ratio)
        {
